...
<head>
    ...
    <style>
        ...
        * {
        ...
        #primary_navigation .navbar-default .navbar-nav>.open>a,
        #primary_navigation .navbar-default .navbar-nav>.open>a:hover,
        #primary_navigation .navbar-default .navbar-nav>.open>a:focus {
        ...
        .accept {
            background: url('../images/green_smiley.png') no-repeat 0 0;
        }

        .reject {
            background: url('../images/red_smiley.png') no-repeat 0 0;
        }
        ...
        .login_btn_cred .Button1 {
            background: url("../images/button_bg.png") no-repeat scroll 0 0 #fff;
            border: 0 none;
            color: #ffffff;
            font-weight: bold;
            height: 36px;
        ...
        .login_cred {
            ...
            line-height: 30px;
            font-weight: normal;
            background: url("../images/seprater.png") no-repeat scroll right 0;
        }
        ...
        @media (min-width: 320px) and (max-width: 767px) {
            ...
            #primary_navigation .navbar-default .navbar-toggle:hover,
            #primary_navigation .navbar-default .navbar-toggle:focus {
                background: none;
            }
        ...
        .alertbox_logo {
            background: url("../images/browser_logo.png") no-repeat center;
            width: 100%;
            height: 55px;
            display: inline-block;
        }
        ...
        .alertbox_icon {
            background: url("../images/ie6_icon.png") no-repeat;
            width: 100%;
            height: 106px;
        ...
        .alertbox_close {
            background: url("../images/ie6_close.jpg") no-repeat;
            width: 68px;
            height: 28px;
            margin-top: -35px;
            float: right;
        ...
        #features {
            background: rgba(0, 0, 0, 0) url("images/features.png") no-repeat scroll 0 -2px;
            bottom: 0;
            color: #0071a5;
            height: 40px;
        ...
        /*Added for Multi language by Jagan Elumalai*/
        .language_selection_btn button {
            border: 0;
            border-radius: 0;
            background-color: #0e6c5a !important;
            color: #fff251 !important;
            font-size: 12px !important;
            padding: 6px 12px;
        }

        .language_selection_btn button:hover,
        button:link,
        button:active,
        button:visited,
        button:focus {
        ...
        .language_selection li {
            float: left;
            padding: 6px 12px;
            border-bottom: 1px solid #188c76;
            color: #fff251;
            cursor: pointer;
            margin: 0 !important;
            ...
            <div class="row" id="header">
                <header id="headerContent">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <a href="http://bank.sbi" target="_blank;" rel="noopener noreferrer" id="logo"
                            aria-label="SBI Logo">&nbsp;</a>
                    </div>
                            ...
                            <div class="pull-right">
                                ...
                                <div id="header_navigation">
                                    ...
                                    <ul id="forms" class="pull-right">
                                        ...
                                        <li id="homeLoanButton"> <a href="https://homeloans.sbi/" target="_blank"
                                                rel="noopener noreferrer" accesskey="3" title="SBI Home Loan"
                                                aria-label="SBI Home Loan">
                                                <!-- <img src="/sbijava/retail/images/HomeLoanButton.png" alt="SBI Home Loan" title="SBI Home Loan"></a></li> -->
                                                <!-- <img src="{{ asset('assets/images/payment-gatway/HomeLoanButton.png') }}" -->
                                                    alt="SBI Home Loan" title="SBI Home Loan"></a></li>
                                        <li class="about">
                                            <a href="/sbijava/retail/html/aboutus.html" target="_blank"
                                                rel="noopener noreferrer" accesskey="3" title="About OnlineSBI"
                                        ...
                                        <li>
                                            <a href="/npersonal/reg_forms.html" target="_blank"
                                                rel="noopener noreferrer" title="Forms" aria-label="Forms">
                                                Forms</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" class="last" onclick="openpopup();"
                                                aria-label="Net Banking Branches">Net Banking Branches</a>
                                        </li>

                                        <li>
                                            <div class="dropdown language_selection_btn">
                                                <button id="dLabel" class="dropdown-toggle" type="button"
                                                    data-toggle="dropdown" aria-expanded="false">Language <span
                                                        class="caret"></span></button>
                                                <ul class="dropdown-menu language_selection" aria-labelledby="dLabel"
                                                    role="menu">

                                                    <li href="#" class="dropdown-item"><a
                                                            href="login.htm?languagecode=en"
                                                            aria-label="English Language"> <span>English</span> </a>
                                                    </li>
                                                    <li href="#" class="dropdown-item"><a
                                                            href="login.htm?languagecode=hi_IN"
                                                            aria-label="Hindi Language"> <span>Hindi</span>
                                                            <span>हिंदी</span></a> </li>
            ...
            <div class="row" id="primary_navigation">
                <nav role="navigation" class="navbar navbar-default" id="navContent">
                    <div class="navbar-header">
                        <button id="ChangeToggle" type="button" data-target="#navbarCollapse" data-toggle="collapse"
                        ...
                        <div class="arrow_icon pull-right hidden-lg hidden-md hidden-sm">
                            <a href="javascript:void(0);" class="arrow arrow_up" aria-label="arrow">&nbsp;</a>
                        </div>
                    </div>
                    <div id="navbarCollapse" class="collapse navbar-collapse nav-comn">
                        <ul class="nav navbar-nav" id="navigation">
                            ...
                            <li class="active_menu"><a href="/" aria-label="Home">Home</a>
                            </li>
                            ...
                            <li><a href="#"
                                    onclick="window.open('/npersonal/productandservices.html','productservice','width=780, height=500, status=1, scrollbars=1, location=0')"
                                    aria-label="Products &amp; Services">Products &amp; Services</a></li>
                            <!--Added for Productions and services post login updation-->
                ...
                href="#">How Do I (Help)</a></li> -->
                            <li><a href="/npersonal/rinb_videos.html" target="_blank" rel="noopener noreferrer"
                                    aria-label="How Do I (Help)">
                                    How Do I (Help)</a></li>

                            <li><a href="https://www.sihub.in/managesi/sbi" target="_blank"
                                    aria-label="Manage Debit Card E-Mandate">Manage Debit Card E-Mandate</a></li>

                            <li><a href="https://retail.onlinesbi.sbi/npersonal/contact_us.html" target="_blank"
             ...
             <div class="row" id="footer">
                ...
                <div id="footer_area">
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <img src="{{ asset('assets/images/payment-gatway//veriSign_logo.png') }}" alt="VeriSign" title="VeriSign">
                    </div>
                ...
                <div class="col-sm-12 col-xs-12" id="best_view" style="width: 1170px;">
                    ...
                    <div class="pull-right hidden-xs">
                        <p>Site best viewed at 1024 x 768 resolution in Microsoft Edge 79 +, Mozilla 96 +, Google Chrome
                            97 +</p>
                    </div>
